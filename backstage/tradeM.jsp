	...
	<body>
		...
		<%
			if(session.getAttribute("id") != null )
			{
				...
				out.print("</b></font>");
				out.print("<br>");
				out.print("<a href='tradeUpdate.jsp'><input type='button' name='button01' value='訂單列表' style='font-size:200%;font-family:Microsoft JhengHei;font-weight:bold;color:green;'></a>" + "&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;");
				out.print("<a href='tradeDelete.jsp'><input type='button' name='button01' value='刪除訂單' style='font-size:200%;font-family:Microsoft JhengHei;font-weight:bold;color:blue;'></a>" + "&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;");
				out.print("<br><br>");
