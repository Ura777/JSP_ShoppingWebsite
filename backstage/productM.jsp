	...
	<body>
		...
		<%
			if(session.getAttribute("id") != null )
			{
				...
				out.print("</b></font>");
				out.print("<br>");
				out.print("<a href='productAdd.jsp'><input type='button' name='button01' value='新增商品' style='font-size:200%;font-family:Microsoft JhengHei;font-weight:bold;color:red;'></a>" + "&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;");
				out.print("<a href='productUpdate.jsp'><input type='button' name='button01' value='修改商品' style='font-size:200%;font-family:Microsoft JhengHei;font-weight:bold;color:green;'></a>" + "&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;");
				out.print("<a href='productDelete.jsp'><input type='button' name='button01' value='刪除商品' style='font-size:200%;font-family:Microsoft JhengHei;font-weight:bold;color:blue;'></a>" + "&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;");
				out.print("<br><br>");
