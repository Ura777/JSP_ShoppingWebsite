				...
				try 
				{
					...
					try 
					{
						...
						else 
						{
							...
							out.print("<td>會員優惠</td>");
							out.print("<td>修改按鈕</td>");
							out.print("</tr>");
							while(temp.next())
							{
								out.print("<tr>");
								...
								out.print("<td>" + temp.getString(9) + "</td>");
								out.print("<td>");
								out.print("<form method='POST' action='updateM.jsp'>");
								out.print("<input type='hidden' name='change' value='" + temp.getString(1) + "'>");
								out.print("<input type='submit' value='按我修改'>");
								out.print("</form>");
								out.print("</td>");
								out.print("</tr>");
							}
