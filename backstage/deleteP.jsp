				...
				try 
				{
					...
					try 
					{
						...
						else 
						{
							...
							out.print("<td>");
							out.print("<form method='POST' action='deleteP2.jsp'>");
							...
							out.print("&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;");
							out.print("<a href='productDelete.jsp'><input type='button' name='button01' value='取消' style='font-size:200%;font-family:Microsoft JhengHei;font-weight:bold;color:green;'></a>");
							out.print("</form>");
							out.print("</td>");
							out.print("</tr>");
							out.print("</table>");
