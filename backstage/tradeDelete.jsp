	...
	<body>
		<%
			if(session.getAttribute("id") != null )
			{
				...
				out.print("</b></font><br>");
				out.print("<font color='#218868' size='5' face='微軟正黑體'><b>清單列表如下↓</b></font>");
				out.print("</p>");
					...
					try 
					{
						...
						else 
						{
							...
							while(temp.next())
							{
								...
								sql2 = "select * from tradeproduct where memberAccount='" + account + "';";
								...
								out.print("</table>");
								out.print("<font size='5' face='微軟正黑體'><b>應付金額(已打折)為" + AccountPayable);
								out.print("<form method='POST' action='deleteT.jsp'>");
								//傳送會員帳號
								out.print("<input type='hidden' name='change' value='" + temp.getString(3) + "'>");
