...
INSERT INTO guestbook VALUES ('25', '測試用', 'Test@test.com', 'testing', '增加CSS\r<br>哈哈', '2016-01-14', '0:0:0:0:0:0:0:1');
INSERT INTO guestbook VALUES ('26', 'testing', 'Test@test.com', 'test for CSS', '如題\r<br>不要問', '2016-01-14', '0:0:0:0:0:0:0:1');
INSERT INTO guestbook VALUES ('27', 'TEST', 'Test@test.com', 'TEST1023', '1024\r<br>2048\r<br>4056\r<br>8096\r<br>呵呵', '2016-01-14', '0:0:0:0:0:0:0:1');
...
INSERT INTO product VALUES ('2', '日本TH 二代 肉襲亂舞 R-20 2nd 子宮快感 自慰器', '飛機杯', '商品尺寸：長約13.5cm*7.4cm<br>商品重量：380g<br>商品材質：高級矽膠<br>商品顏色：膚色', '大幅降低抽插時的阻力，粉嫩微子宮設計。<br>真實猥褻的加工內壁，特殊凹槽設計享受破處快感。<br>快吸入的快感噴發升天，獨特的厚度絕佳肉感包覆。<br>此自慰孔使用了安全安心物料。<br>滑順手感可長期使用，絕佳的耐久度，讓你遠離刺鼻臭味。<br>沐浴乳清洗也OK喔。', '850', '99', 'image\\product');
INSERT INTO product VALUES ('3', '潮吹戰神 虛擬膚質 擬真吸盤式老二棒', '陽具', '商品尺寸：約155mm*40mm<br>商品材質：高級矽膠<br>商品顏色：膚色', '高級矽膠製造。<br>形逼真設計精巧 ，如真人勃起時的狀態。<br>棒身精細的雕塑出實體老二的造型。<br>超粗猛堅固的陽具，表面還有鼓起的血管。<br>吸附(盤)式設計，可任意固定於光滑面，如地板或牆面上，使妳的性愛有更多的選擇。<br>可用於夫妻調情，女性自慰，刺激敏感區域，提高性生活質量的目的。逼真刺激，防滑的表面處理，增加性感部位磨擦，能對女性敏感部位造成強烈刺激。', '280', '99', 'image\\product');
...
INSERT INTO product VALUES ('7', '肛門後庭塞-妖狐的誘惑', '後庭', '商品材質：軟膠肛塞 + 人造狐狸毛<br>商品尺寸：狐狸尾巴:長約360mm ;後庭塞:107mm*35mm<br>商品顏色：黑色', '狐狸尾巴的變身cosplay用具就是這麼神秘，插上肛門塞就變成狐美人。<br>給愛人插上，盡顯狐狸的野性！<br>即使走動的過程中也不會掉下，更不用說對此尾巴拉拉扯扯過程中帶來的快感和樂趣！<br>快快行動！可以變化的可愛狐狸就是你！', '550', '99', 'image\\product');
...
INSERT INTO product VALUES ('10', '杜蕾斯Durex杜蕾斯熱感潤滑液', '潤滑液', '商品容量：50ml', '世界知名品牌DUREX，50ml精裝超值版。\r<br>最受玩家歡迎的必備款，隨性所致，在每個調情時刻散發魔力。', '175', '98', 'image\\product');
...
INSERT INTO trademember VALUES ('2', '測試人員2', 'test02', '一律皆為宅配到府', '0922222222', '桃園市平鎮區不告訴你', '一般');
...
INSERT INTO tradeproduct VALUES ('4', '日本TH 二代 肉襲亂舞 R-20 2nd 子宮快感 自慰器', '2', '飛機杯', '850', '1', '0', 'test02');
INSERT INTO tradeproduct VALUES ('5', '潮吹戰神 虛擬膚質 擬真吸盤式老二棒', '3', '陽具', '280', '1', '0', 'test02');
INSERT INTO tradeproduct VALUES ('6', '肛門後庭塞-妖狐的誘惑', '7', '後庭', '550', '1', '0', 'test02');
INSERT INTO tradeproduct VALUES ('7', '杜蕾斯Durex杜蕾斯熱感潤滑液', '10', '潤滑液', '175', '2', '1827', 'test02');
