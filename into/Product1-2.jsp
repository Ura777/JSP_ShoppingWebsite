...
<html>
	<head><title>飛機杯系列OωO</title></head>
		...
		<%
				...
				try
			{
				...
				try
				{
					...
					String picturePath = "";
					String color = "";
					String limitCondition = "飛機杯";  //SQL的where條件句
					int adNumber = 0;
					...
					else
					{
						...
						while(temp.next())
						{
							...
							if (Q>0)
							{
								...
								{
									out.print("<tr>" + "<td rowspan='6' width='40%'>" + "<a href='https://www.youtube.com/watch?v=QScnSKmapmo' target='_blank'><img src = " + picturePath + " >" + "</a></td>");
								}
								else if (temp.getString(1).equals("2"))
								{
									out.print("<tr>" + "<td rowspan='6' width='40%'>" + "<a href='https://www.youtube.com/watch?v=DcCsLs7UnEI' target='_blank'><img src = " + picturePath + " >" + "</a></td>");
								}
								else
								{
							...
							else
							{
								if (temp.getString(1).equals("1"))
								{
									out.print("<tr>" + "<td rowspan='5' width='40%'>" + "<a href='https://www.youtube.com/watch?v=QScnSKmapmo' target='_blank'><img src = " + picturePath + " >" + "</a></td>");
								}
								else if (temp.getString(1).equals("2"))
								{
									out.print("<tr>" + "<td rowspan='5' width='40%'>" + "<a href='https://www.youtube.com/watch?v=DcCsLs7UnEI' target='_blank'><img src = " + picturePath + " >" + "</a></td>");
								}
								else
								{
