	...
	<body background='image\view.jpg'>
		...
		<%
				...
				try
				{
					...
					else
					{
						...
						else
						{
							...
							out.print("<font color='red' size='7' face='微軟正黑體'><b>您的購物車內沒有東西，所以無法成立訂單！</b></font>");
							out.print("</p>");
							ck=false;
						}
			...
			catch(ClassNotFoundException err)
			{
				...
				if (ck==true)
				{
					out.print("<a href='Carttransfer2.jsp'><input type='button' name='button01' value='來去下一頁' style='font-size:200%;font-family:Microsoft JhengHei;font-weight:bold;color:blue;'></a>" + "&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;");
				}
