	...
	<body background='image\view.jpg'>
		<%
			if(session.getAttribute("id") != null )
			{
				...
				out.print("<font color='red' size='7' face='微軟正黑體'><b>新增成功！！！</b></font>");
				out.print("</p>");
				...
				out.print("<td><input type='submit' name='button01' value='按我回到會員區' style='font-size:200%;font-family:Microsoft JhengHei;font-weight:bold;color:blue'><br></td>");
				out.print("</tr>");
				out.print("</table>");
				out.print("</form>");
			}
