		...
		<%
				...
				try
			{
				...
				try
				{
					...
					String picturePath = "";
					String color = "";
					String limitCondition = "陽具";  //SQL的where條件句
					int adNumber = 0;
					...
					else
					{
						...
						while(temp.next())
						{
							...
							if (Q>0)
							{
								if (temp.getString(1).equals("3"))
								{
									out.print("<tr>" + "<td rowspan='6' width='5%'>" + "<a href='https://www.youtube.com/watch?v=rye5lQqxEgM' target='_blank'><img src = " + picturePath + " >" + "</a></td>");
								}
								else if (temp.getString(1).equals("4"))
								{
									out.print("<tr>" + "<td rowspan='6' width='5%'>" + "<a href='https://www.youtube.com/watch?v=dj_ay0ILkjQ&oref=https%3A%2F%2Fwww.youtube.com%2Fwatch%3Fv%3Ddj_ay0ILkjQ&has_verified=1' target='_blank'><img src = " + picturePath + " >" + "</a></td>");
								}
								else
								{
									out.print("<tr>" + "<td rowspan='6' width='5%'>" + "<img src = " + picturePath + " >" + "</td>");
								}
							...
							else
							{
								if (temp.getString(1).equals("3"))
								{
									out.print("<tr>" + "<td rowspan='5' width='5%'>" + "<a href='https://www.youtube.com/watch?v=rye5lQqxEgM' target='_blank'><img src = " + picturePath + " >" + "</a></td>");
								}
								else if (temp.getString(1).equals("4"))
								{
									out.print("<tr>" + "<td rowspan='5' width='5%'>" + "<a href='https://www.youtube.com/watch?v=dj_ay0ILkjQ&oref=https%3A%2F%2Fwww.youtube.com%2Fwatch%3Fv%3Ddj_ay0ILkjQ&has_verified=1' target='_blank'><img src = " + picturePath + " >" + "</a></td>");
								}
								else
								{
