	...
	<body background='image\view.jpg'>
		...
		<%
			...
			catch(ClassNotFoundException err)
			{
				...
				out.print("<a href='Information.jsp'><input type='button' name='button01' value='我的資料' style='font-size:200%;font-family:Microsoft JhengHei;font-weight:bold;color:red;'></a>" + "&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;");
				out.print("<a href='Trade.jsp'><input type='button' name='button01' value='我的訂單' style='font-size:200%;font-family:Microsoft JhengHei;font-weight:bold;color:green;'></a>" + "&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;");
				out.print("<a href='Cart.jsp'><input type='button' name='button01' value='我的購物車' style='font-size:200%;font-family:Microsoft JhengHei;font-weight:bold;color:blue;'></a>" + "&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;");
				out.print("</p>");
			}
			else
			{
