		...
		<%
				...
				try
			{
				...
				try
				{
					...
					String picturePath = "";
					String color = "";
					String limitCondition = "套套";  //SQL的where條件句
					int adNumber = 0;
					...
					else
					{
						...
						while(temp.next())
						{
							...
							if (Q>0)
							{
								if (temp.getString(1).equals("5"))
								{
									out.print("<tr>" + "<td rowspan='6' width='5%'>" + "<a href='https://www.youtube.com/watch?v=mNO6TMkIORM' target='_blank'><img src = " + picturePath + " >" + "</a></td>");
								}
								else if (temp.getString(1).equals("6"))
								{
									out.print("<tr>" + "<td rowspan='6' width='5%'>" + "<a href='https://www.youtube.com/watch?v=HXbYbKjTWq0' target='_blank'><img src = " + picturePath + " >" + "</a></td>");
								}
								else
								{
							...
							else
							{
								if (temp.getString(1).equals("5"))
								{
									out.print("<tr>" + "<td rowspan='5' width='5%'>" + "<a href='https://www.youtube.com/watch?v=mNO6TMkIORM' target='_blank'><img src = " + picturePath + " >" + "</a></td>");
								}
								else if (temp.getString(1).equals("6"))
								{
									out.print("<tr>" + "<td rowspan='5' width='5%'>" + "<a href='https://www.youtube.com/watch?v=HXbYbKjTWq0' target='_blank'><img src = " + picturePath + " >" + "</a></td>");
								}
								else
								{
