				...
				try 
				{
					...
					try 
					{
						...
						else 
						{
							...
							String new_temptradeid=request.getParameter("tempID");

							//只有填東西才能放進資料庫
							if ((new_quantity=="") || (new_account=="") || (new_productid=="") || (new_temptradeid==""))
							{
								con.close();
							...
							else
							{
								...
								//Step 4: 執行 SQL 指令 新增	
								sql = "update tempTrade set productQuantity='" + new_quantity + "' where id='" + new_temptradeid + "';";
								con.createStatement().execute(sql);
								...
								//Step 5: 顯示結果 
								//直接顯示最新的資料
								response.sendRedirect("Cartupdate3.jsp");
							}
